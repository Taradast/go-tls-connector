...
- Пренаправляет поступающие запросы в порт бекенда.  
...
"Minercraft client" --localhost--> "tls-connector_client" ===Internet===> "tls-connector_server" --localhost--> "Minercraft server"
